  ...
  const whyChooseUs = [
    {
      ...
      title: "فريق متخصص",
      description:
        "مهندسون واستشاريون ذوو خبرات عميقة في مختلف المجالات الهندسية",
    },
    {
      number: "02",
      title: "معايير عالية",
  ...
  return (
    <PageLayout
      hero={
        <HeroSection
          title="من نحن"
          description="تعرف على شركة غازي محمد عباس للاستشارات الهندسية"
          eyebrow="قصتنا"
        />
      }
    >
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div>
                <h2 className="text-3xl font-bold text-primary mb-4">
                  شركة غازي محمد عباس للاستشارات الهندسية
                </h2>
                <p className="text-lg text-foreground/70 leading-relaxed">
                  شركة هندسية سعودية معتمدة، متخصصة في تقديم حلول تصميم
                  واستشارات هندسية شاملة ومتطورة.
                </p>
              </div>

              <p className="text-foreground/70 leading-relaxed">
                نمتلك فريقًا مؤهلاً بخبرات طويلة في مختلف التخصصات الهندسية،
                ونلتزم بأحدث معايير التصميم والاستدامة، لنكون الشريك المثالي
                للعملاء الباحثين عن الجودة والدقة والموثوقية.
              </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70">
                      أن نكون من الرواد في مجال الاستشارات الهندسية في المملكة
                      العربية السعودية
                    </p>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <img
                src="/photoApp/meeting-room.jpeg"
      ...
      <section className="section-modern">
        <div className="container">
          <SectionHeading
            title="لماذا تختار شركة غازي محمد عباس؟"
      ...
      <section className="section-modern bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-5xl font-bold mb-2">2687+</div>
